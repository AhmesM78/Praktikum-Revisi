...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'ketoprak',
      home: buildHomePage('ahmes  - 2211102112'),
    );
  }
  ...
  Widget buildHomePage(String title) {
    ...
    const subTitle = Text(
      'Makan ketoprak berarti menikmati hidangan khas Indonesia yang terbuat dari potongan lontong atau ketupat, bihun, tahu, tauge, dan disiram dengan bumbu kacang',
